...
type AWSResponse = {FailedRecordCount: number, Records: AWSResponseRecord[]}
*/
...
class KinesisWritable extends FlushWritable {
  ...
  constructor (client/*: Object */, streamName/*: string */, {highWaterMark = 16, logger, maxRetries = 3, retryTimeout = 100, wait = 500} = {}) {
    if (!client) {
  ...
  _write (data/*: any */, encoding/*: any */, callback/*: Function */) {
  ...
  getPartitionKey (data/*: any */)/*: string */ {
    return '0'
  };

  _prepRecord (data/*: any */)/*: Record */ {
    return {
  ...
  getQueueSpliceIdx ()/*: number */ {
    // TODO records to this.collectionMaxSize
    return Math.min(this.queue.length, this.collectionMaxCount)
  }
  ...
  writeRecords ()/*: Promise<void> */ {
    return new Promise((resolve, reject) => {
      ...
      const records = this.queue.splice(0, this.getQueueSpliceIdx())
