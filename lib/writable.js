...
class KinesisWritable extends FlushWritable {
  ...
  writeRecords ()/*: Promise<void> */ {
    return new Promise((resolve, reject) => {
      ...
      // TODO move `_prepRecord` into `_write` to avoid redoing work when retrying and to do data size calculations
